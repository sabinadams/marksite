...
export class MapPage {
    ...
    map: any;
    constructor( public _navCtrl: NavInterceptor, private geolocation: Geolocation ) {
    }
    ...
    ionViewDidLoad(){
      ...
      loadMap(){
        ...
        if ( localStorage.getItem('last_location') != undefined ) {
          ...
          mapOptions['center'] = new google.maps.LatLng(loc.lat,loc.long);
          ...
          this.geolocation.getCurrentPosition().then((resp) => {
            ...
            mapOptions['center'] = new google.maps.LatLng(resp.coords.latitude, resp.coords.longitude);
            this.map = new google.maps.Map(this.mapElement.nativeElement, mapOptions);
           }).catch((error) => {
             console.log('Error getting location', error);
           });
